...
Board::Board() {
    ...
    ships[2] = new PatrolBoat(4, 0, HORIZONTAL);
...
Board::Board(bool isPlayer) {
    ...
    ships[2] = new PatrolBoat(0, 0, HORIZONTAL);
    ...
    while (numSet < 5) {
        ...
        if (!isPlayer) {
            ...
            switch (numSet) {
                case 0:
                    printf(" The Airplane Carrier of length 5");
                    break;
                case 1:
                    printf("The Battleship of length 4");
                    break;
                case 2:
                    printf("The Destroyer of length 3");
                    break;
                case 3:
                    printf("The Patrol Boat of length 2");
                    break;
                case 4:
                    printf("The Submarine Carrier of length 3");
                    break;
            }
            printf("\nRow: \t");
            fflush(stdout);
